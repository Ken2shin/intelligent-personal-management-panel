...
<body class="text-slate-900 overflow-x-hidden">
    ...
    <nav class="fixed top-4 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl z-50 liquid-glass rounded-3xl px-6 h-16 flex items-center justify-between">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('login')); ?>" class="text-sm font-bold py-2.5 px-5 rounded-2xl hover:bg-white/40 transition-all active:scale-95">Entrar</a>
            <a href="<?php echo e(route('register')); ?>" class="text-sm font-bold bg-slate-900 text-white py-2.5 px-6 rounded-2xl hover:bg-slate-800 transition-all shadow-lg active:scale-95">Empezar</a>
        </div>
    </nav>
    ...
    <header class="relative pt-48 pb-24 px-6">
        <div class="max-w-5xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <a href="<?php echo e(route('register')); ?>" class="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-indigo-600 hover:shadow-2xl hover:shadow-blue-500/40 text-white font-bold py-5 px-12 rounded-3xl transition-all hover:-translate-y-1 active:scale-95">
                    Crear mi Espacio
                </a>
            </div>
        </div>
...
</html><?php /**PATH C:\Users\EMANUELCLEMENTEMARTI\Downloads\intelligent-personal-management-panel\resources\views/welcome.blade.php ENDPATH**/ ?>