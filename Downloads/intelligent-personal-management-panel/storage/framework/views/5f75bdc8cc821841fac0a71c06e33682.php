            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mt-6 text-center text-sm text-slate-600">
                <p>¿Ya tienes cuenta? <a href="<?php echo e(route('login')); ?>" class="text-blue-500 hover:text-blue-700 font-semibold">Inicia sesión</a></p>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\EMANUELCLEMENTEMARTI\Downloads\intelligent-personal-management-panel\resources\views/auth/register.blade.php ENDPATH**/ ?>