...
<head>
    ...
    <title><?php echo e(config('app.name', 'PanelPro Enterprise')); ?></title>
            ...
            <nav class="flex-1 px-5 space-y-4 overflow-y-auto mt-6 min-w-[320px]">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route($item['route'])); ?>" 
                       class="flex items-center gap-5 px-6 py-5 rounded-[2rem] transition-all duration-500 group <?php echo e(request()->routeIs($item['route']) ? 'bg-white shadow-2xl shadow-blue-600/10 text-blue-600 scale-[1.02]' : 'text-slate-500 hover:bg-white/60 hover:text-slate-900'); ?>">
                        <div class="flex-shrink-0">
                            <svg class="w-6 h-6 group-hover:scale-110 transition-transform duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($item['svg']); ?>"/></svg>
                        </div>
                        <span class="text-sm font-black tracking-tight whitespace-nowrap"><?php echo e($item['label']); ?></span>
                    </a>
                ...
                <div class="flex items-center gap-4" x-data="{ open: false }">
                    <div @click="open = !open" class="flex items-center gap-5 bg-white/60 p-2 pr-8 rounded-[2.5rem] border border-white hover:border-blue-200 transition-all cursor-pointer shadow-xl shadow-blue-900/5 relative group">
                        ...
                        <div class="text-left leading-tight hidden md:block">
                            ...
                            <p class="text-base font-bold text-slate-900 tracking-tighter"><?php echo e(Auth::user()->name); ?></p>
                        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('mensaje')): ?>
            <div class="pointer-events-auto liquid-glass border border-white p-6 rounded-[2.5rem] shadow-2xl flex items-center gap-5" 
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-[11px] font-bold text-slate-500 mt-1 truncate"><?php echo e(session('mensaje')); ?></p>
                </div>
            </div>
...
</html><?php /**PATH C:\Users\EMANUELCLEMENTEMARTI\Downloads\intelligent-personal-management-panel\resources\views/layouts/app.blade.php ENDPATH**/ ?>