<div class="min-h-screen bg-[#f8faff] transition-all duration-1000 overflow-hidden relative">
    ...
    <div class="max-w-7xl mx-auto px-6 py-12 relative z-10">
        ...
        <div class="mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            <div class="space-y-2">
                ...
                <h1 class="text-5xl font-black tracking-tighter text-slate-900 leading-none font-jakarta">
                    Bienvenido, <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600"><?php echo e(Auth::user()->name); ?></span>
                </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false"
                ...
                <div class="flex items-center justify-between relative z-10">
                    <div>
                        ...
                        <p class="text-4xl font-black text-slate-900 tracking-tighter"><?php echo e($tareasCompletadas); ?></p>
                    </div>
            ...
            <div x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false"
                ...
                <div class="flex items-center justify-between relative z-10">
                    <div>
                        ...
                        <p class="text-4xl font-black text-slate-900 tracking-tighter"><?php echo e($tareasHoy); ?></p>
                    </div>
            ...
            <div x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false"
                ...
                <div class="flex items-center justify-between relative z-10">
                    <div>
                        ...
                        <p class="text-4xl font-black text-slate-900 tracking-tighter"><?php echo e($habitosHoy); ?></p>
                    </div>
            ...
            <div x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false"
                 class="liquid-glass p-8 rounded-[2.5rem] border border-white shadow-xl transition-all duration-500 relative overflow-hidden"
                 :class="hover ? 'translate-y-[-8px] shadow-2xl ' + (<?php echo \Illuminate\Support\Js::from($balanceTotal >= 0)->toHtml() ?> ? 'border-emerald-200' : 'border-rose-200') : '' ">
                <div class="flex items-center justify-between relative z-10">
                    <div>
                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Cash Flow</p>
                        <p class="text-3xl font-black tracking-tighter <?php echo e($balanceTotal >= 0 ? 'text-emerald-600' : 'text-rose-600'); ?>">
                            <?php echo e($balanceTotal >= 0 ? '+' : '-'); ?>$<?php echo e(number_format(abs($balanceTotal), 0)); ?>

                        </p>
                    </div>
                    <div class="w-12 h-12 rounded-2xl flex items-center justify-center <?php echo e($balanceTotal >= 0 ? 'bg-emerald-500/10 text-emerald-600' : 'bg-rose-500/10 text-rose-600'); ?>">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div class="lg:col-span-2 liquid-glass p-10 rounded-[3.5rem] border border-white shadow-2xl">
                <div class="flex justify-between items-center mb-10">
                    ...
                    <a href="<?php echo e(route('tareas')); ?>" class="px-6 py-2 bg-slate-100 rounded-full text-[10px] font-black uppercase tracking-widest text-slate-500 hover:bg-blue-600 hover:text-white transition-all">Explorar Todo</a>
                </div>
                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tareasDelDia->count() > 0): ?>
                    <div class="space-y-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tareasDelDia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tarea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="group flex items-center gap-6 p-6 bg-white/40 rounded-3xl border border-white/60 hover:bg-white hover:shadow-xl transition-all duration-500">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="font-bold text-slate-900 text-lg tracking-tight truncate"><?php echo e($tarea->titulo); ?></p>
                                    <span class="inline-flex mt-2 px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest
                                        <?php if($tarea->prioridad === 'alta'): ?> bg-rose-50 text-rose-600 
                                        <?php elseif($tarea->prioridad === 'media'): ?> bg-amber-50 text-amber-600 
                                        <?php else: ?> bg-emerald-50 text-emerald-600 <?php endif; ?>">
                                        <?php echo e($tarea->prioridad); ?>
            ...
            <div class="space-y-10">
                <div class="bg-gradient-to-br from-indigo-600 to-blue-700 rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        <p class="text-7xl font-black tracking-tighter mb-2"><?php echo e($notasCreadas); ?></p>
                ...
                <div class="liquid-glass p-10 rounded-[3.5rem] border border-white shadow-2xl">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaccionesRecientes->count() > 0): ?>
                        <div class="space-y-6">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $transaccionesRecientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaccion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between group">
                                    <div class="flex-1 min-w-0 pr-4">
                                        <p class="font-bold text-slate-800 text-sm truncate group-hover:text-blue-600 transition-colors"><?php echo e(strtoupper($transaccion->categoria)); ?></p>
                                        <p class="text-[10px] font-medium text-slate-400 truncate tracking-wide">ID: <?php echo e($transaccion->id); ?></p>
                                    </div>
                                    <p class="font-black text-sm <?php echo e($transaccion->tipo === 'ingreso' ? 'text-emerald-500' : 'text-rose-500'); ?>">
                                        <?php echo e($transaccion->tipo === 'ingreso' ? '+' : '-'); ?>$<?php echo e(number_format($transaccion->monto, 0)); ?>
...
</div><?php /**PATH C:\Users\EMANUELCLEMENTEMARTI\Downloads\intelligent-personal-management-panel\resources\views/livewire/dashboard/dashboard.blade.php ENDPATH**/ ?>