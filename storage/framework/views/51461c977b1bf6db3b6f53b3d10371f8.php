    ...
    <div class="max-w-7xl mx-auto px-6 py-12 relative z-10">
        ...
        <div x-show="formOpen"
            ...
            <h2 class="text-3xl font-black text-slate-900 mb-10 flex items-center gap-4 font-jakarta">
                ...
                <span x-text=" <?php echo \Illuminate\Support\Js::from($editandoId)->toHtml() ?> ? 'Refinar Estrategia de Hábito' : 'Configurar Nueva Disciplina' "></span>
            </h2>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex flex-col sm:flex-row gap-6 pt-6">
                    <button type="submit" 
                        ...
                        <span wire:loading.remove wire:target="crear"><?php echo e($editandoId ? 'ACTUALIZAR MÉTRICA' : 'DESPLEGAR HÁBITO'); ?></span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $habitos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $habito): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div wire:key="habito-<?php echo e($habito->id); ?>" 
                     x-data="{ hovered: false }" @mouseenter="hovered = true" @mouseleave="hovered = false"
                    class="liquid-glass rounded-[3rem] shadow-xl transition-all duration-500 p-10 flex flex-col border-t-[8px] <?php echo e(($habito->completado_hoy > 0) ? 'border-emerald-400' : 'border-blue-400'); ?>"
                    :class="hovered ? 'translate-y-[-10px] shadow-2xl' : '' ">
                    
                    <div class="flex justify-between items-start mb-6">
                        <div class="flex-1 pr-4">
                            <h3 class="text-2xl font-black text-slate-900 tracking-tight leading-tight mb-2 transition-colors" :class="hovered ? 'text-blue-600' : '' "><?php echo e($habito->nombre); ?></h3>
                            <p class="text-sm font-medium text-slate-400 line-clamp-2 italic leading-relaxed"><?php echo e($habito->descripcion); ?></p>
                        </div>
                        <button wire:click="eliminar(<?php echo e($habito->id); ?>)" 
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-10">
                        <div class="bg-white/40 p-5 rounded-[2rem] text-center border border-white/60 shadow-inner">
                            <div class="flex items-center justify-center gap-2 text-blue-600 mb-1">
                                ...
                                <span class="text-3xl font-black"><?php echo e($habito->racha); ?></span>
                            </div>
                        ...
                        <div class="bg-white/40 p-5 rounded-[2rem] text-center border border-white/60 shadow-inner">
                             <div class="flex items-center justify-center gap-2 text-indigo-600 mb-1">
                                ...
                                <span class="text-3xl font-black"><?php echo e($habito->puntos); ?></span>
                            </div>
                    ...
                    <div class="mt-auto flex gap-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($habito->completado_hoy > 0): ?>
                            <button wire:click="desmarcarCompletado(<?php echo e($habito->id); ?>)" 
                        ...
                        <?php else: ?>
                            <button wire:click="marcarCompletado(<?php echo e($habito->id); ?>)" 
                        ...
                        <button wire:click="editar(<?php echo e($habito->id); ?>)" 
...
</div><?php /**PATH C:\Users\EMANUELCLEMENTEMARTI\Downloads\intelligent-personal-management-panel\resources\views/livewire/habitos/habitos.blade.php ENDPATH**/ ?>