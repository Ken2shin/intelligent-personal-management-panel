    ...
    <div class="max-w-7xl mx-auto px-6 py-12 relative z-10">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-16">
            ...
            <button wire:click="$toggle('mostrarFormulario')" 
                ...
                <span class="mr-3 text-xl"><?php echo e($mostrarFormulario ? '✕' : '+'); ?></span>
                <span class="tracking-tight"><?php echo e($mostrarFormulario ? 'Cerrar Panel' : 'Nueva Tarea'); ?></span>
            </button>
        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mostrarFormulario): ?>
            <div class="liquid-glass mb-16 p-10 rounded-[3rem] border border-white shadow-2xl shadow-blue-900/5 animate-slide-down relative overflow-hidden">
                ...
                <h2 class="text-3xl font-black text-slate-900 mb-10 flex items-center gap-4">
                    ...
                    <?php echo e($editandoId ? 'Editar registro existente' : 'Crear nueva actividad'); ?>
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-[10px] font-black uppercase tracking-tighter ml-4"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="flex flex-col sm:flex-row gap-6 pt-6">
                        <button type="submit" 
                            ...
                            <span wire:loading.remove wire:target="crear"><?php echo e($editandoId ? 'ACTUALIZAR PIPELINE' : 'DESPLEGAR TAREA'); ?></span>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100/50">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $tareas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tarea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr wire:key="tarea-<?php echo e($tarea->id); ?>" class="group hover:bg-white/80 transition-all duration-500">
                                <td class="px-10 py-8">
                                    <div class="text-xl font-bold text-slate-900 group-hover:text-blue-600 transition-colors tracking-tight"><?php echo e($tarea->titulo); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tarea->descripcion): ?>
                                        <div class="text-sm font-medium text-slate-400 mt-2 line-clamp-1 italic"><?php echo e($tarea->descripcion); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="px-10 py-8 text-center">
                                    <span class="inline-flex px-5 py-2 rounded-[1rem] text-[9px] font-black uppercase tracking-widest shadow-sm
                                        <?php if($tarea->prioridad === 'alta'): ?> bg-red-50 text-red-500 border border-red-100
                                        <?php elseif($tarea->prioridad === 'media'): ?> bg-amber-50 text-amber-600 border border-amber-100
                                        <?php else: ?> bg-emerald-50 text-emerald-600 border border-emerald-100
                                        <?php endif; ?>">
                                ...
                                <td class="px-10 py-8 text-center">
                                    <select wire:change="cambiarEstado(<?php echo e($tarea->id); ?>, $event.target.value)" 
                                        ...
                                        <option value="pendiente" <?php echo e($tarea->estado === 'pendiente' ? 'selected' : ''); ?>>PENDIENTE</option>
                                        <option value="en_progreso" <?php echo e($tarea->estado === 'en_progreso' ? 'selected' : ''); ?>>PROGRESO</option>
                                        <option value="completada" <?php echo e($tarea->estado === 'completada' ? 'selected' : ''); ?>>COMPLETADA</option>
                                    </select>
                                </td>
                                <td class="px-10 py-8 text-center text-xs font-black text-slate-400 tracking-tighter">
                                    <?php echo e($tarea->fecha_limite ? \Carbon\Carbon::parse($tarea->fecha_limite)->format('d . M . Y') : '---'); ?>
...
</div><?php /**PATH C:\Users\EMANUELCLEMENTEMARTI\Downloads\intelligent-personal-management-panel\resources\views/livewire/tareas/tareas.blade.php ENDPATH**/ ?>