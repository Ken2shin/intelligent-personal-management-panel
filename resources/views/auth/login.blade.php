    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="mt-6 text-center text-sm text-slate-600">
                <p>¿No tienes cuenta? <a href="{{ route('register') }}" class="text-blue-500 hover:text-blue-700 font-semibold">Regístrate</a></p>
                <p class="mt-2"><a href="{{ route('password.request') }}" class="text-blue-500 hover:text-blue-700 font-semibold">¿Olvidaste tu contraseña?</a></p>
            </div>
